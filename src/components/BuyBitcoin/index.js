...
import { Row, Input, Button, Col, List, Typography, Form } from 'antd';
...
function BuyBitcoin() {
    ...
    return (
        ...
        <div style={{ margin: 160, marginLeft: 100 }}>
            ...
            <Button onClick={e => { history(e, Name, Note, Amount); steHis('Name: '+Name+' Note: '+ Note +' Amount : '+ Amount) }} style={style.btn}>Buy</Button>
